...
def printResults(y_test, y_pred, methodName, averageName):
    ...
    prec = precision_score(y_test, y_pred, average = averageName)
    print(f'{methodName}: Precision is {prec:.3f}')
    rec = recall_score(y_test, y_pred, average = averageName)
    print(f'{methodName}: Recall is {rec:.3f}')
    f1 = f1_score(y_test, y_pred, average = averageName)
