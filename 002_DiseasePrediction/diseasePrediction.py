...
# Linear regression
linearRegression.linearRegression(x_train, x_test, y_train_ohe, y_test_ohe)
...
supportVectorMachine.supportVectorMachine(x_train, x_test, y_train_ord, y_test_ord)
